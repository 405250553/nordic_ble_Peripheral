...
from OpenGL.GL import glViewport, glMatrixMode, GL_PROJECTION, glLoadIdentity, GL_MODELVIEW,glShadeModel
from OpenGL.GL import GL_SMOOTH, glClearColor, glClearDepth, glEnable, glDepthFunc, glHint, GL_DEPTH_TEST
from OpenGL.GL import GL_LEQUAL, GL_PERSPECTIVE_CORRECTION_HINT, GL_NICEST, glClear, glTranslatef
from OpenGL.GL import GL_COLOR_BUFFER_BIT, GL_DEPTH_BUFFER_BIT, glRotatef, glBegin, glColor3f
from OpenGL.GL import glVertex3f, GL_QUADS, glEnd, glRasterPos3d, glDrawPixels, GL_UNSIGNED_BYTE, GL_RGBA
from OpenGL.GLU import gluPerspective
from OpenGL.GLUT import glutDestroyWindow, glutMainLoop
...
def draw(w, nx, ny, nz):
    ...
    if(useQuat):
        ...
        glRotatef(2 * math.acos(w) * 180.00/math.pi, -1*ny, -1*nz, nx)
